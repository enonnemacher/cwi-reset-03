...
import br.com.cwi.reset.edersonrafaelnonnemacher.exception.DiretorNaoEncontradoComFiltroException;
import br.com.cwi.reset.edersonrafaelnonnemacher.exception.ListaDiretoresVazioException;
import br.com.cwi.reset.edersonrafaelnonnemacher.exception.MesmoNomeException;
import br.com.cwi.reset.edersonrafaelnonnemacher.exception.anoAtividadeMaiorNascimentoDiretorException;
import br.com.cwi.reset.edersonrafaelnonnemacher.exception.dataNascimentoMaiorDiretorException;
import br.com.cwi.reset.edersonrafaelnonnemacher.exception.diretorSemSobrenomeException;
import br.com.cwi.reset.edersonrafaelnonnemacher.exception.idDiretorException;
...
public class DiretorService {
    ...
    public List listarDiretores(String filtroNome) throws ListaDiretoresVazioException, DiretorNaoEncontradoComFiltroException {
        ...
        if (listaDiretores.isEmpty()) {
            ...
            for (Diretor diretor : listaDiretores) {
                ...
                if (buscaDiretores.isEmpty()) {
                    throw new DiretorNaoEncontradoComFiltroException(filtroNome);
                }
            }
        }
